...
### 0. Git操作に関する重要なルール（最優先）

**最重要**: **プッシュは明示的な指示がある場合のみ実行してください**

- ✅ **コミットはOK**: 変更をコミットすることは問題ありません
- ❌ **プッシュは禁止**: ユーザーから明示的に「プッシュしてください」と指示されるまで、**絶対にプッシュしないでください**
- ⚠️ **例外**: ユーザーが明示的に「コミットプッシュしてください」と指示した場合のみプッシュ可能
